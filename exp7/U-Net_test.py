...
log_dir = r"E:\explore\U-Net\logs_train"
result_dir = r"E:\explore\U-Net\result"
zaoseng_dir = r"E:\explore\U-Net\zaoseng"
model_path = r"E:\explore\U-Net\model"
...
def test(model, loader):
    ...
    with torch.no_grad():
        for data, idx in loader:
            ...
            Image.fromarray(noisy_np).save(os.path.join(zaoseng_dir, f'{sigma}_U-Net_noisy_{base}.png'))
            Image.fromarray(denoised_np).save(os.path.join(result_dir, f'{sigma}_U-Net_denoised_{base}.png'))
    ...
    print(f'\nAvg_time:{total_time/total_imgs:.4f}s | Avg_PSNR:{total_psnr/total_imgs:.2f} | Avg_SSIM:{total_ssim/total_imgs:.4f}')
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(os.path.join(model_path, "unet_best.pth"), map_location=device))
