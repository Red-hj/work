...
train_dataset = datasets.FashionMNIST(root=r'C:\Users\19019\Desktop\data', train=True, download=True,transform=transform)
test_dataset = datasets.FashionMNIST(root=r'C:\Users\19019\Desktop\data', train=False, download=True,transform=transform)
